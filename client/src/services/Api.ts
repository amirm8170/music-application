...
export const USERINFORMATIONSURLS = [
  process.env.REACT_APP_DEVELOP_BASE_API + "/user-songs/",
  process.env.REACT_APP_DEVELOP_BASE_API + "/user-likedSongs/",
  process.env.REACT_APP_DEVELOP_BASE_API + "/user-videos/",
  process.env.REACT_APP_DEVELOP_BASE_API + "/user-events/",
