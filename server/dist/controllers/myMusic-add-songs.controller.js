...
exports.addSongToMyMusic = void 0;
const songs_model_1 = require("./../models/songs.model");
const mongoose_1 = __importDefault(require("mongoose"));
const error_middleware_1 = require("./../middlewares/error.middleware");
const user_model_1 = require("./../models/user.model");
const addSongToMyMusic = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (isSong) {
            throw new error_middleware_1.CustomError(400, "you already have this song!");
        }
...
exports.addSongToMyMusic = addSongToMyMusic;
